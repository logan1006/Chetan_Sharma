...
<title>Borrowed Book Data</title>
</head>
<body>
...
<div class="wrap">
  ...
  <div class="container">
   ...
   <li><span><a href="StudentData.jsp">Student Info</a></span></li>
	...
	<section id="content">
	<strong>Enter Book Details to Check</strong><br>
    <form action="BorrowDetails" method="get">
	<ul class="form-style-1">
	<li>
        <label>Book ID <span class="required">*</span></label>
        <input type="text" name="bID" class="field-long" required />
    </li>
    <li>
        <label>Student ID <span class="required">*</span></label>
       <input type="text" name="sID" class="field-long" />
    </li>
	<li>
