...
<title>Get Book Information</title>
</head >	
<body>
...
<div class="wrap">
  ...
  <div class="container">
	...
	<section id="content">
	<strong>Enter Book Details</strong><br>
   ...
   <li>
        <label>Book Group ID <span class="required">*</span></label>
        <input type="text" name="G_ID" class="field-long"  required/>
    </li>
	<li>
    ...
    <li>
        ...
        <input type="text" name="ed" class="field-long"  required/>
    </li>
	<li>
        <label>Author <span class="required">*</span></label>
        <input type="text" name="aname" class="field-long"  required/>
    </li>
	<li>
        <label>Publisher</label>
        <input type="text" name="pb" class="field-long" />
    </li>
	<li>
