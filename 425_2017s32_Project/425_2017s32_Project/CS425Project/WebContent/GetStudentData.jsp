...
<div class="wrap">
  ...
  <div class="container">
	...
	<section id="content">
	<strong>Enter Student Details</strong><br>
	...
	<li>
        ...
        <input type="text" name="pID" class="field-long" required/>
    </li>
	<li>
        <label>Program ID<span class="required">*</span></label>
        <input type="text" name="pgmID" class="field-long" required/>
    </li>
	<li>
