...
<title>Update Instructor Data</title>
</head>
<body>
...
<div class="wrap">
  ...
  <div class="container">
   ...
   <li><span><a href="StudentData.jsp">Student Info</a></span></li>
	...
	<section id="content">
	<strong>Enter Book Details to Update</strong><br>
    ...
    <li>
        <label>Book Group ID
       <input type="text" name="G_ID" class="field-long" />
    </li>
	<li>
        <label>Book Name 
	...
	<li>
        <label>Edition 
        <input type="text" name="ed" class="field-long" />
    </li>
	<li>
        <label>Author
        <input type="text" name="aname" class="field-long" />
    </li>
	<li>
        <label>Publisher 
